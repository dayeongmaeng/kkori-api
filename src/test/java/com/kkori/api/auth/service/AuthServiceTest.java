...
class AuthServiceTest {
    ...
    void oauthLoginCreatesUserConnectsDeviceAndMigratesDevicePets() {
        ...
        when(oauthVerifier.verify("id-token")).thenReturn(userInfo);
        ...
        OAuthLoginResponse response = authService.login(
                new OAuthLoginRequest(OAuthProvider.GOOGLE, "id-token", null, "device-1")
        );
    ...
    void oauthLoginReusesExistingUser() {
        ...
        when(oauthVerifier.verify("access-token")).thenReturn(userInfo);
        ...
        OAuthLoginResponse response = authService.login(
                new OAuthLoginRequest(OAuthProvider.KAKAO, null, "access-token", "device-1")
        );
